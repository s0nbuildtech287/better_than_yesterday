    ...
    <aside className={`w-72 h-screen sticky top-0 flex flex-col justify-between p-5 bg-white dark:bg-[#0E131F] border-r border-slate-200 dark:border-slate-800/80 transition-colors z-30 flex-shrink-0 ${className}`}>
      ...
      <div>
        ...
        <button
          ...
          className="w-full mb-6 py-3 px-4 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold text-sm shadow-md shadow-amber-500/20 active:scale-95 transition-all flex items-center justify-center gap-2"
        >
      ...
      <div className="space-y-3 pt-4 border-t border-slate-200 dark:border-slate-800">
        ...
        <button
          ...
          className="w-full py-2.5 px-3 rounded-xl bg-gradient-to-r from-rose-500/10 to-amber-500/10 hover:bg-rose-500/20 border border-rose-500/30 text-rose-600 dark:text-rose-400 font-bold text-xs transition-all flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          className="w-full py-2.5 px-3 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold text-xs transition-all flex items-center justify-between hover:bg-slate-200 dark:hover:bg-slate-700"
        >
