...
export const WelcomeWidget: React.FC<WelcomeWidgetProps> = ({
  ...
  return (
    <div className="modern-card p-6 sm:p-8 bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white relative overflow-hidden border-indigo-500/30">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-extrabold bg-white/10 backdrop-blur-md border border-white/20 ${greetingColor}`}>
          ...
          <p className="text-sm text-slate-300 max-w-xl font-medium">
            Hôm nay bạn đã sẵn sàng chiến thắng sự lười biếng để tốt hơn 1% chưa? Mỗi hành động nhỏ đều tích lũy thành kết quả lớn!
          </p>
        </div>

        {/* Right Real-time Clock Display */}
        <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-950/70 border border-indigo-500/30 backdrop-blur-md shadow-xl flex-shrink-0 w-full lg:w-auto justify-between lg:justify-start">
